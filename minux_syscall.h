#ifndef MINUX_SYSCALL_H
#define MINUX_SYSCALL_H

// Minimal Minux9 syscall helpers for bare-metal userland programs.
// Provides inline wrappers for write(2) and exit(2) so simple programs
// can call the kernel without pulling in the full libc shim.
